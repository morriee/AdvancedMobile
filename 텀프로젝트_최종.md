Papaya Diary
================================================
## 파파야 전체 소스코드 링크: https://github.com/morriee/Papaya3
contents
-----------
+ 소개
+ UI
...
## Papaya Diary 를 만들게 된 계기  
    오늘 한 일을 sns에 일기처럼 작성하고 싶지만 sns에 가입하기 부담스러운 분들을 위해서
    나만 볼 수 있는 다이어리를 만들자 는 생각에서 시작하였습니다. 
    메모, 캘린더, 날씨 처럼 평상시 자주 쓰는 기능들을 다이어리에 추가하였습니다.
...
### 1. 날씨 & 미세먼지
  현재 날짜의 날씨와 미세먼지를 볼 수 있습니다.
	     ...
	     //날씨 이미지와 현재기온, 미세먼지와 오존 농도는 네이버 날씨에서 불러옴
...
### 4. 피드
  오늘 일과를 사진과 글로 기록하고 장소를 태그하는 앨범입니다.
	    ...
	    5) View에서 사진을 누르면 map액티비티로 넘어가서 현재 출력된 좌표위치에 map 확인
	    
	     6)adapter를 이용한 recyclerView에 저장된 feed 출력
